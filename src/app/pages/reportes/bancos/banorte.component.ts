...
generarReporte() {
  ...
  this._reportesservice.getBanorte(fecharepor,type).subscribe(resp => {this.facturas = resp;
                                                                  swal2.close();
  ...
  exportexcel() {
    ...
    let header=['ID factura', 'Operacion', 'Clave', 'Cuenta origen', 'Cuenta destino', 'Importe', 'Referencia', 'Descripcion', 'RFC Ordenante', 'IVA', 'Fecha aplicacion', 'Instruccion pago'];
    ...
    for (const prop in this.facturas) {
      ...
      console.log(fecapli) */
      worksheet.addRow([this.facturas[prop].id_factura,this.facturas[prop].oper,this.facturas[prop].clave_id,this.facturas[prop].cuenta_origen,
        (this.facturas[prop].cuenta_destino).toString(),this.facturas[prop].importe,this.facturas[prop].referencia,this.facturas[prop].descripcion,this.facturas[prop].rfc_ordenante,
        this.facturas[prop].iva,this.facturas[prop].fecha_aplicacion,this.facturas[prop].instruccion_pago,]);
